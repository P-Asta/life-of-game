...
const LifeOfGameFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_lifeofgame_free(ptr >>> 0));
/**
*/
export class LifeOfGame {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(LifeOfGame.prototype);
        obj.__wbg_ptr = ptr;
        LifeOfGameFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        LifeOfGameFinalization.unregister(this);
        return ptr;
    }
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_pack_pra_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
